...
╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗
<a href=https://t.me/UrvashiTheaters>📯 ഉർവശി തീയറ്റേർസ് 📯</a>
╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝</b>""" 
...
"""
    ...
    MVE_NT_FND = """<b>𝚃𝙷𝙸𝚂 𝙼𝙾𝚅𝙸𝙴 I𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝙾𝚁 𝙰𝙳𝙳𝙴𝙳 𝚃𝙾 𝙳𝙰𝚃𝚂𝙱𝙰𝚂𝙴 ᶜᵒⁿᵗᵃᶜᵗ ᴴᵉʳᵉ👉 @SreejithSKumar</b> """
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    I_CUDNT = """𝑯𝑬𝑳𝑳𝑶 {} 𝑰 𝑪𝑶𝑼𝑳𝑫𝑵'𝑻 𝑭𝑰𝑵𝑫 𝑨𝑵𝒀 𝑴𝑶𝑽𝑰𝑬 𝑰𝑵 𝑻𝑯𝑨𝑻 𝑵𝑨𝑴𝑬 ᶜᵒⁿᵗᵃᶜᵗ ᴴᵉʳᵉ👉 @SreejithSKumar."""

    I_CUD_NT = """𝑯𝑬𝑳𝑳𝑶 {} 𝑰 𝑪𝑶𝑼𝑳𝑫𝑵'𝑻 𝑭𝑰𝑵𝑫 𝑨𝑵𝒀𝑻𝑯𝑰𝑵𝑮 𝑹𝑬𝑳𝑨𝑻𝑬𝑫 𝑻𝑶 𝑻𝑯𝑨𝑻 . 𝑪𝑯𝑬𝑪𝑲 𝒀𝑶𝑼𝑹 𝑺𝑷𝑬𝑳𝑳𝑰𝑵𝑮.ᶜᵒⁿᵗᵃᶜᵗ ᴴᵉʳᵉ👉 @SreejithSKumar"""
